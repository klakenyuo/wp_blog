        ...
        <main class="post blog-post col-lg-8"> 
          <div class="container">
            <div class="post-single">
              <div class="post-thumbnail"><img src=<?= get_theme_file_uri("img/blog-post-3.jpeg")?> alt="..." class="img-fluid"></div>
              <div class="post-details">
                <div class="post-meta d-flex justify-content-between">
                  <div class="category"><a href="#"><?php the_category(",")?></a></div>
                </div>
                <h1><?php the_title()?><!--<a href="#"><i class="fa fa-bookmark-o"></i></a>--></h1>
                  ...
                  <div class="comment">
                    <div class="comment-header d-flex justify-content-between">
                      <div class="user d-flex align-items-center">
                        <div class="image"><img src=<?= get_theme_file_uri("img/user.svg")?> alt="..." class="img-fluid rounded-circle"></div>
          ...
          <div class="widget latest-posts">
            ...
            <div class="blog-posts"><a href="#">
                <div class="item d-flex align-items-center">
                  <div class="image"><img src=<?= get_theme_file_uri("img/small-thumbnail-1.jpg")?> alt="..." class="img-fluid"></div>
